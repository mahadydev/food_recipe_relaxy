...
_$UsImpl _$$UsImplFromJson(Map<String, dynamic> json) => _$UsImpl(
      amount: (json['amount'] as num?)?.toDouble(),
      unitShort: json['unitShort'] as String?,
      unitLong: json['unitLong'] as String?,
    );

Map<String, dynamic> _$$UsImplToJson(_$UsImpl instance) => <String, dynamic>{
      'amount': instance.amount,
      'unitShort': instance.unitShort,
      'unitLong': instance.unitLong,
    };
...
_$TasteImpl _$$TasteImplFromJson(Map<String, dynamic> json) => _$TasteImpl(
      ...
      bitterness: (json['bitterness'] as num?)?.toInt(),
      savoriness: (json['savoriness'] as num?)?.toInt(),
